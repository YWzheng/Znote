package com.ywzheng.loading.widget;
...
public class IQiYiLoadingView extends View {
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.IQiYiLoading_circleWidth:
                    paintStrokeWidth = array.getDimension(attr, dip2px(mContext, 1));
                    break;
                default:
                    break;
            }
    ...
    private void init() {
        ...
        trianglePaint.setStrokeWidth(dip2px(mContext, 1));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthSpecMode == MeasureSpec.AT_MOST && heightSpecMode == MeasureSpec.AT_MOST) {
            setMeasuredDimension(Math.min(dip2px(mContext, DEFAULT_SIZE), widthSpecSize), Math.min(dip2px(mContext, DEFAULT_SIZE), heightSpecSize));
        } else if (widthSpecMode == MeasureSpec.AT_MOST) {
            setMeasuredDimension(Math.min(dip2px(mContext, DEFAULT_SIZE), widthSpecSize), heightSpecSize);
        } else if (heightSpecMode == MeasureSpec.AT_MOST) {
            setMeasuredDimension(widthSpecSize, Math.min(dip2px(mContext, DEFAULT_SIZE), heightSpecSize));
        }
    }
