package com.ywzheng.znote.pay.alipay;
...
public class AlipayAPI {
	...
	public static String pay(Activity activity, String subject, String body, String price) {
		 ...
		 * 
		 * 使用Post向服务器提交订单数据，服务器中需要生成数字签名，返回给客户端
		 * Post可能需要两个参数：支付协议（payProtocol）、订单信息（orderInfo），返回数字签名（sign）
		 */
		/*
		...
		*/
		...
		// 直接模拟获取服务器返回数据
		String payInfo = "{\"appid\":\"wxb4ba3c02aa476ea1\",\"partnerid\":\"1305176001\",\"package\":\"Sign=WXPay\",\"noncestr\":\"d2b6b0a5d9e34985b25f9aae4a5870fb\",\"timestamp\":1471157767,\"prepayid\":\"wx20160814145606ae516e1cab0546608985\",\"sign\":\"CBD851CE8BF4486740064017DAE26755\"}";
