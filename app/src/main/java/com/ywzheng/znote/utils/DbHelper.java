...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.beginTransaction();
        try {
            db.execSQL(CREATE_IMAGE_SDCARD_CACHE_TABLE_SQL.toString());
            db.execSQL(CREATE_IMAGE_SDCARD_CACHE_TABLE_INDEX_SQL.toString());

            db.execSQL(CREATE_HTTP_CACHE_TABLE_SQL.toString());
            db.execSQL(CREATE_HTTP_CACHE_TABLE_INDEX_SQL.toString());
            db.execSQL(CREATE_HTTP_CACHE_TABLE_UNIQUE_INDEX.toString());
